## Qt 5.15.2 with WinTab support

-----

This version is made based on v5.15.2 with cherry-picking the following commit to the qtbase module, in order to make it enable to use WinTab API in Qt 5.15.2:
...
With the above change, WinTab API can be used by calling `QWindowsWindowFunctions::setWinTabEnabled(true);` .

### Source Code

You can find the source code tree to build this package and track the modifications here:
https://github.com/shun-iwasawa/qt5/tree/v5.15.2_wintab

### Build Configurations

This package is built by the following command lines:
```
...
Note that the license files under `Licenses` folder are copied from the official package.

### Dependent Libraries

This package is built by using the following libraries / softwares.
